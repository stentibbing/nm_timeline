...
class Nm_timeline
{
    ...
    private function define_admin_hooks()
    {
        ...
        $this->loader->add_action('init', $plugin_admin, 'register_event_cpt');
        $this->loader->add_action('load-edit.php', $plugin_admin, 'list_add_event_date');
        $this->loader->add_action('add_meta_boxes', $plugin_admin, 'add_datepicker_metabox');
        $this->loader->add_action('save_post', $plugin_admin, 'save_datepicker_date');
