...
class Nm_timeline {
	 ...
	 * @since    1.0.0
	 * @access   protected
	 * @var      Nm_timeline_Loader    $loader    Maintains and registers all hooks for the plugin.
	 */
	protected $loader;
	 ...
	 *
	 * - Nm_timeline_Loader. Orchestrates the hooks of the plugin.
	 * - Nm_timeline_i18n. Defines internationalization functionality.
	 * - Nm_timeline_Admin. Defines all hooks for the admin area.
	 * - Nm_timeline_Public. Defines all hooks for the public side of the site.
	 *
	 ...
	 *
	 * Uses the Nm_timeline_i18n class in order to set the domain and to register the hook
	 * with WordPress.
	 *
	 * @since    1.0.0
	 * @access   private
	 ...
	 *
	 * @since     1.0.0
	 * @return    Nm_timeline_Loader    Orchestrates the hooks of the plugin.
	 */
